    ...
    <div class="container mt-5">
        <table class="table table-striped">
            <tr class="table-primary">
                <th colspan="7" class="text-center"><h3>INVOICE ITEM REPORT</h3></th>
            </tr>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $sql = "SELECT * FROM invoice_item WHERE date BETWEEN '$startDate' AND '$endDate';";
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    echo "<tr class='table-light'> 
                        ...
                        <td class='table-light'>" . $row['customer_name'] . "</td>
